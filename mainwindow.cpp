...
////        //idx
////        fragment_combiner_ptr->OutputResultWithTxt("D:/qt_project/R_analyze/计算机定性结果/idx");//输出txt文件
////        fragment_combiner_ptr->OutPutWithCsv("D:/qt_project/R_analyze/计算机定性结果/idx");//输出csv文件
